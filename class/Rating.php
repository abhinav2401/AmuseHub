...
class Rating{
	...
	public function getItemRating($itemId){
		$sqlQuery = "SELECT r.ratingId, r.itemId, r.userID, u.NAME, r.ratingNumber, r.title, r.comments, r.created, r.modified FROM ".$this->itemRatingTable." as r
